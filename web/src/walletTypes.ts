...
export interface Policy {
  ...
  maximum_executed_block_size: number
...
const typeMap: any = {
  Wallet: o(
    [
      ...
      {
        json: 'unassigned_key_pairs',
        js: 'unassigned_key_pairs',
        typ: r('UnassignedKeyPairs'),
      },
  ...
  ChainValue: o(
    [
      ...
      { json: 'key_pair', js: 'key_pair', typ: u(r('KeyPair'), null) },
      { json: 'block_hash', js: 'block_hash', typ: null },
  ...
  KeyPair: o([{ json: 'Ed25519', js: 'Ed25519', typ: '' }], false),
  GenesisConfig: o(
    [
  ...
  Protocol: o([{ json: 'Grpc', js: 'Grpc', typ: '' }], false),
  Policy: o(
    [
      ...
      {
        json: 'service_as_oracle_query',
        js: 'service_as_oracle_query',
        typ: '',
      },
      { json: 'http_request', js: 'http_request', typ: '' },
      {
        json: 'maximum_fuel_per_block',
        js: 'maximum_fuel_per_block',
        typ: 3.14,
      },
      {
        json: 'maximum_service_oracle_execution_ms',
        js: 'maximum_service_oracle_execution_ms',
        typ: 3.14,
      },
      {
        json: 'maximum_executed_block_size',
        js: 'maximum_executed_block_size',
        typ: 3.14,
      },
      { json: 'maximum_bytecode_size', js: 'maximum_bytecode_size', typ: 3.14 },
      { json: 'maximum_blob_size', js: 'maximum_blob_size', typ: 3.14 },
      {
        json: 'maximum_published_blobs',
        js: 'maximum_published_blobs',
        typ: 3.14,
      },
      {
        json: 'maximum_block_proposal_size',
        js: 'maximum_block_proposal_size',
        typ: 3.14,
      },
      {
        json: 'maximum_bytes_read_per_block',
        js: 'maximum_bytes_read_per_block',
        typ: 3.14,
      },
      {
        json: 'maximum_bytes_written_per_block',
        js: 'maximum_bytes_written_per_block',
        typ: 3.14,
      },
      {
        json: 'maximum_oracle_response_bytes',
        js: 'maximum_oracle_response_bytes',
        typ: 3.14,
      },
      {
        json: 'maximum_http_response_bytes',
        js: 'maximum_http_response_bytes',
        typ: 3.14,
      },
      {
        json: 'http_request_timeout_ms',
        js: 'http_request_timeout_ms',
        typ: 3.14,
      },
      {
        json: 'http_request_allow_list',
        js: 'http_request_allow_list',
        typ: a(''),
      },
    ],
    false
  ),
  UnassignedKeyPairs: o([], false),
}
